...
protected:
   double mFitness;
public:
   Solution(void) : mFitness(0.0) {};
   virtual double fitness(void) const { return mFitness; };
   virtual void calculateFitness(void) { };
   virtual Solution* mutate(void) { return NULL; };
   virtual Solution* crossover(Solution* other) { return NULL; };
